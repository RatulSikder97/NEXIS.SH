...
data = json.load(open('markdown/build/chapter_pages_print.json'))
...
open('markdown/00_toc_print.md', 'w').write('\n'.join(lines))
print(f'Wrote print TOC with offset={offset}, {len(data)} entries')
